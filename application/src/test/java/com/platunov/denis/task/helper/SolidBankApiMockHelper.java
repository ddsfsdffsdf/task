...
import com.platunov.denis.task.integration.bank.solid.client.DefaultApi;
...
@Component
public class SolidBankApiMockHelper {
    private static final String basePath = "/api/SolidBank";
